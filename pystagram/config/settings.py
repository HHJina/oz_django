...
# Email
# 이메일을 보내기 위한 백엔드 설정
#from django.core.mail.backend.smtp import EmailBackend
...
EMAIL_USE_SSL = False  # SSL을 사용하는 경우 True로 설정하고, EMAIL_PORT는 465로 변경

# 이메일 계정 설정
EMAIL_HOST_USER = SECRET['email']['user']  # 발신자 이메일 주소
EMAIL_HOST_PASSWORD = SECRET['email']['password']  # 이메일 비밀번호 (또는 앱 비밀번호)
