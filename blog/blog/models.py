...
from utils.models import TimestampModel # 모델 생성하고 import
...
class Blog(TimestampModel):
    ...
    # ImageField, FileField와 같지만 이미지만 업로드가능
    ...
    def save(self,*args,**kwargs):
        ...
        thumbnail_name = image_path.stem # /blog/2026/02/03/thumbnail.png => thumbnail
        thumbnail_extension = image_path.suffix # /blog/2026/02/03/thumbnail.png => .png
